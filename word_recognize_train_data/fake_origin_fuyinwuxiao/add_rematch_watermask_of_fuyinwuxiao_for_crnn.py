...
def add_text_to_image(image, text, p):
    ...
    image_draw.rectangle((p_new, (p_new[0] + 177, p_new[1] + 50)), outline=(pix_rand, pix_rand, pix_rand, bright_random), width=4)
...
def run(filename):
    ...
    if True:
        ...
        cv2.imwrite(os.path.join(dst_path, filename), img_res)
    print(filename)

if __name__ == "__main__":
    cnt = 0
    path = './fake_real_color_data_fuyinwuxiao'
