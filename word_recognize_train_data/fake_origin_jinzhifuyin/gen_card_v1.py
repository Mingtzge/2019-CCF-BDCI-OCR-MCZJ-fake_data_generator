...
if __name__ == "__main__":
    ...
    result_card_path = os.path.join(ori_path, r'fake_real_color_data_jinzhifuyin')  # 伪造原始身份证样本结果路径
    ori_csv_file = os.path.join(ori_path, r'src', "generate_labels2.csv")  # 原始数据
    gen_faker_card_run()
