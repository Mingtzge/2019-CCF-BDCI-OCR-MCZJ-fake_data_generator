...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoints_dir", default="../../pytorch-CycleGAN-and-pix2pix/models_data", help="experience name of training")
    ...
    header_dir = "small_data_for_crnn_finetune"
